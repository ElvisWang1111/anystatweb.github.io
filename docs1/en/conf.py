...
# If true, messages that are not translated will be printed as warnings
gettext_warning = True
...
html_logo = str(CURR_PATH.parent / '_static'/ 'logo.png')
html_favicon = str(CURR_PATH.parent / '_static'/ 'icon.png')